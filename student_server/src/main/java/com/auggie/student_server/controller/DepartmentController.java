...
public class DepartmentController {
    ...
    public String importDepartments(@RequestParam("file") MultipartFile file) {
        ...
        return departmentService.importFromExcel(file);
    }
    ...
    public ResponseEntity<byte[]> downloadTemplate() throws IOException {
        Workbook workbook = departmentService.generateImportTemplate();
        ...
        headers.setContentDispositionFormData("attachment", "学院批量导入模板.xlsx");

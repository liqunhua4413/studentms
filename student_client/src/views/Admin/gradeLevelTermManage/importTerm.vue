  ...
  <div>
    ...
    >
      ...
      <div slot="tip" class="el-upload__tip">
        模板列顺序：学期名称、开始日期、结束日期、状态(1启用/0停用)、备注。仅管理员可操作。
      </div>
    </el-upload>
...
export default {
  ...
  methods: {
    ...
    customUpload(options) {
      ...
      this.axios
        .post('/term/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
        .then(res => {
    ...
    downloadTemplate() {
      this.axios.get('/term/template', { responseType: 'blob' }).then(resp => {
